...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Pizzadelphia web application."
  #
  #
  ...
  #
  # settings.secret_key_base= _v4IDCQy2voaSC28cuJv4gGcY5FA9dN4cwXrr-b1k48
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("pizzadelphia.log", "w"))
  #
  #
end
